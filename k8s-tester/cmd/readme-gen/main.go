...
func createDoc() string {
	...
	b.WriteByte('\n')
	b.WriteString(es.writeDoc(k8s_tester.ENV_PREFIX+stress_in_cluster.EnvRepository()+"_", &aws_v1_ecr.Repository{}))
	b.WriteByte('\n')
	b.WriteString(es.writeDoc(k8s_tester.ENV_PREFIX+stress_in_cluster.EnvK8sTesterStressFlag()+"_", &stress_in_cluster.K8sTesterStressFlag{}))
	b.WriteByte('\n')
	b.WriteString(es.writeDoc(k8s_tester.ENV_PREFIX+stress_in_cluster.EnvK8sTesterStressFlagRepository()+"_", &aws_v1_ecr.Repository{}))
